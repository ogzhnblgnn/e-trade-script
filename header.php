        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-6 col-md-4 main-logo">
                    <a href="index.php"><img width="400" src=<?php echo $ayarcek['ayar_logo'] ?> alt="logo" class="logo img-responsive"></a>
                </div>
                <div class="col-md-8">
                    <div class="pushright">
                        <div class="top">
                                    ...
                                    <div class="col-md-6 regform">
                                        ...
                                        <form role="form" action="nedmin/netting/islem.php" method="POST">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="kullanici_mail" id="username" placeholder="Mail">
                                            </div>
                                            <div class="form-group">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="navbar-collapse collapse">
                            <ul class="nav navbar-nav">
                                ...
                                <!-- menu tablosundaki menülerin listelenmesi -->
