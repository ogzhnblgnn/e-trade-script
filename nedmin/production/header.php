...
//Admin girişinde oluşturulan session header'a bağımlı tüm sayfalarda geçerli olmalı.
//kullanici_mail baz alınarak oluşturulan session'dan kullanıcının verileri de header'a bağlı tüm sayfalarda sorgulanabilir.
...
// Ayar tablosundaki veriler header'a bağımlı tüm sayfalarda geçerlidir.
        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="index.html" class="site_title"><i class="fa fa-keyboard-o"></i> <span>Oğuzhan Bilgin</span></a>
                </div>
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-cogs"></i> Ayarlar <span class="fa fa-cog"></span></a>
                                <ul class="nav child_menu">
                                    ...
                                    <li><a href="sosyal-ayar.php">Sosyal Ağlar</a></li>
                            ...
                            <li><a href=menu.php><i class="fa fa-bars"></i> Menü Ayar </a></li>
                            <li><a href=slider.php><i class="fa fa-image"></i> Slider Ayar </a></li>
