...
--
-- Anamakine: localhost
-- Üretim Zamanı: 29 May 2021, 19:01:32
...
INSERT INTO `ayar` (`ayar_id`, `ayar_logo`, `ayar_title`, `ayar_description`, `ayar_keywords`, `ayar_author`, `ayar_tel`, `ayar_gsm`, `ayar_fax`, `ayar_mail`, `ayar_ilce`, `ayar_il`, `ayar_adres`, `ayar_mesai`, `ayar_maps`, `ayar_analystic`, `ayar_zopim`, `ayar_facebook`, `ayar_twitter`, `ayar_google`, `ayar_youtube`, `ayar_smtphost`, `ayar_smtpuser`, `ayar_smtppassword`, `ayar_smtpport`, `ayar_bakim`) VALUES
(0, 'dimg/22737logo.jpeg', 'E-Ticaret Proje Örneği', 'E-Ticaret proje çalışma örneği', 'e-ticaret, shopping, phpss', 'Oğuzhan Bilgin', '(+90) 545 385 59 98', '(+90) 545 385 59 98', '(+90)545 385 59 98', 'ogzhnbxx@gmail.com', 'Canik', 'Samsun', 'Hasköy mh. Karaçam Sk. Damla Elit C-1', '7 x 24 açık E-Ticaret Scripti', 'ayar_maps_api', 'ayar_analystic_api', 'ayar_zopim_api', 'www.facebook.com', 'www.twitter.com', 'www.google.com', 'www.youtube.com', 'mail.alanadiniz.com', 'smtpuser', 'password', '587', '1');
...
(0, 'Hakkımızda Alanı Başlık', '<p><img alt=\"\" src=\"https://upload.wikimedia.org/wikipedia/commons/2/27/PHP-logo.svg\" style=\"height:50px; width:93px\" /><em><strong>&nbsp;ile admin panelli e-ticaret proje &ouml;rneği.</strong></em></p>\r\n', 'nnXhnvmRhp4', 'Vizyon içerik', 'Misyon içerik');
...
INSERT INTO `kullanici` (`kullanici_id`, `kullanici_zaman`, `kullanici_resim`, `kullanici_tc`, `kullanici_ad`, `kullanici_mail`, `kullanici_gsm`, `kullanici_sifre`, `kullanici_adsoyad`, `kullanici_adres`, `kullanici_il`, `kullanici_ilce`, `kullanici_unvan`, `kullanici_yetki`, `kullanici_durum`) VALUES
(1, '2021-05-16 01:49:18', '', '', '', 'ogzhnbxx@gmail.com', '0545 385 59 98', 'e10adc3949ba59abbe56e057f20f883e', 'Oğuzhan Bilgin', '', '', '', '', '5', 1),
(6, '2021-05-22 12:42:55', '', '', '', 'sadsadas@asdasd', '', '303afa47adc42a3aa87fcfedbbdf2652', 'sadsads', '', '', '', '', '1', 1),
(7, '2021-05-22 13:04:45', '', '', '', 'camcihuseyin@gmail.com', '', 'd6ea4aee03f5808b2cf7d78c88c8c2d0', 'Camcı Hüseyin', '', '', '', '', '1', 1),
(8, '2021-05-22 13:07:09', '', '', '', 'zinzin@gmail.comss', '65464654654', 'e10adc3949ba59abbe56e057f20f883e', '', '', '', '', '', '1', 1);
...
(5, '0', 'Kategoriler', '<p>asşldjasdaslkdjaskljdkwq</p>\r\n', '', 2, '1', 'kategoriler'),
(6, '0', 'İletişim', '', '', 3, '1', 'iletisim'),
(8, '', 'Gizlilik Koşulları', '', '', 0, '1', 'gizlilik-kosullari'),
...
CREATE TABLE `slider` (
  ...
  `slider_yol` varchar(250) COLLATE utf8_turkish_ci NOT NULL,
...
INSERT INTO `slider` (`slider_id`, `slider_ad`, `slider_yol`, `slider_sira`, `slider_link`, `slider_durum`) VALUES
(7, 'Slider1', 'dimg/slider/30165245512321125451slide-1.jpg', 1, '', '1'),
(8, 'Slider2', 'dimg/slider/28759233333097820023slide-2.jpg', 2, '', '1'),
(9, 'Slider3', 'dimg/slider/31763248032943024484slide-3.jpg', 3, '', '1'),
(10, 'Slider4', 'dimg/slider/24901301472156030772slide-4.jpg', 4, '', '0');
