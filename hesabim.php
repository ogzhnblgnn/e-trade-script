        ...
        <div class="col-md-12">
            <div class="page-title-wrap">
                <div class="page-title-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="bigtitle">Kullanıcı Bilgilerini Güncelle</div>
                            <p >Kullanıcı kayıt işlemlerini aşağıda ki form aracılığı ile güncelleyebilirsiniz.</p>
                        </div>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group dob">
                    <div class="col-sm-12">
                        ...
                        <input type="text" class="form-control" disabled  required="" name="kullanici_adsoyad" placeholder="Ad ve Soyadınızı Giriniz...">
                    </div>

                </div>
                <div class="form-group">
                    <div class="col-sm-12">
                        <input type="email" class="form-control" required="" name="kullanici_mail"  placeholder="<?php $_SESSION['userkullanici_mail'] ?>">
                    </div>
                </div>
                <div class="form-group dob">
                    <div class="col-sm-6">
